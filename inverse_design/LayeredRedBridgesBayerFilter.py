...
class LayeredRedBridgesBayerFilter(device.Device):

	def __init__(self, size, permittivity_bounds, init_permittivity, num_z_layers, num_free_iterations_between_patches):
		super(LayeredRedBridgesBayerFilter, self).__init__(size, permittivity_bounds, init_permittivity)
	...
	def init_variables(self):
		super(LayeredRedBridgesBayerFilter, self).init_variables()
