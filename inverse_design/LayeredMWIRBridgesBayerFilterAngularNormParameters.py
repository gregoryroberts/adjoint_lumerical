...
device_vertical_maximum_um = 0#device_size_verical_um
...
fdtd_simulation_time_fs = 3000 * 5
...
#
# Frequency Selection, Angular Points and Polarization Selection
#
lambda_eval_um = 5.25

num_phi = 32#64#60#8#16#60#8#16#8
