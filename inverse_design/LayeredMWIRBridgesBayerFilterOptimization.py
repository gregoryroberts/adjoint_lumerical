...
bayer_filter = LayeredMWIRBayerFilter.LayeredMWIRBridgesBayerFilter(bayer_filter_size_voxels, [min_device_permittivity, max_device_permittivity], init_permittivity_0_1_scale, num_vertical_layers)
