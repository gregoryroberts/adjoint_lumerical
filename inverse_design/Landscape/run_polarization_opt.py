...
mesh_size_nm = 8
density_coarsen_factor = 1#8#4#1#12#1#12#24#12#32#24#48#12#48
...
device_width_voxels = int( 10 * density_coarsen_factor / 2 ) * 8
device_height_voxels = int( 4 * density_coarsen_factor / 2 ) * 8
