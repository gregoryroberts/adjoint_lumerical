...
import CMOSDielectricBayerFilter
...
shutil.copy2(python_src_directory + "/CMOSDielectricBayerFilterParameters.py", projects_directory_location + "/ArchiveCMOSDielectricBayerFilter.py")
...
bayer_filter = CMOSDielectricBayerFilter.CMOSDielectricBayerFilter(
