...
projects_directory_location += "/" + project_name + "_continuous_reflective_red_tio2_v24"
...
# load_index = np.load('/Users/gregory/Downloads/device_1_redirect_si_10p8_red_tio2_v23.npy')
