...
if run_on_cluster:
	...
	projects_directory_location = projects_directory_location_base + '_narrow_angular_bfast_32_snell_large_focal_ypol_v3'#dilated_250nm'#dense'
else:
...
dilation_erosion_test = False#True#False#True
dilation_amount = 0#1
