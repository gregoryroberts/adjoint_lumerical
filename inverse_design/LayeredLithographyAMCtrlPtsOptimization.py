...
shutil.copy2(python_src_directory + "/LayeredLithographyAMBayerFilterCtrlPts.py", projects_directory_location + "/LayeredLithographyAMBayerFilterCtrlPts.py")
...
for epoch in range(start_epoch, num_epochs):
	...
	for iteration in range(0, num_iterations_per_epoch):
		...
		control_points_gradient = bayer_filter.backpropagate(device_gradient)

		step_size_control_points = ctrl_pts_change_start_epoch + ( iteration / ( num_iterations_per_epoch - 1 ) ) * ( ctrl_pts_change_end_epoch - ctrl_pts_change_start_epoch )
