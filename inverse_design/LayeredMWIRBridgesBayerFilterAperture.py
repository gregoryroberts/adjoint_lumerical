...
class LayeredMWIRBridgesBayerFilterAperture(device.Device):

	def __init__(self, size, permittivity_bounds, init_permittivity, num_z_layers, num_free_iterations_between_patches):
		super(LayeredMWIRBridgesBayerFilterAperture, self).__init__(size, permittivity_bounds, init_permittivity)
	...
	def init_variables(self):
		super(LayeredMWIRBridgesBayerFilterAperture, self).init_variables()
