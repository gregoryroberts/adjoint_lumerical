...
from LayeredMWIRBridgesBayerFilterParametersNRL import *
import LayeredMWIRBridgesBayerFilterNRL
...
projects_directory_location = projects_directory_location_base + '_filled_dilated_double'
...
shutil.copy2(python_src_directory + "/LayeredMWIRBridgesBayerFilterParametersNRL.py", projects_directory_location + "/LayeredMWIRBridgesBayerFilterParametersNRL.py")
shutil.copy2(python_src_directory + "/LayeredMWIRBridgesBayerFilterNRL.py", projects_directory_location + "/LayeredMWIRBridgesBayerFilterNRL.py")
shutil.copy2(python_src_directory + "/LayeredMWIRBridgesBayerFilterEvaluationFillNRL.py", projects_directory_location + "/LayeredMWIRBridgesBayerFilterEvaluationFillNRL.py")
...
transmission_monitors.append( transmission_monitor_focal )
...
permittivity_layer_substrate['z min'] = ( device_vertical_minimum_um - platform_thickness_um ) * 1e-6
permittivity_layer_substrate['z max'] = device_vertical_minimum_um * 1e-6
...
platform_z_range = 1e-6 * np.linspace( ( device_vertical_minimum_um - platform_thickness_um ), device_vertical_minimum_um, 2 )
...
eval_lambda_min_um = lambda_min_um - 0.25
