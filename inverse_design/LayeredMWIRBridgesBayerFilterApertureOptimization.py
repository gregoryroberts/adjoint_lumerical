...
for xy_idx in range(0, 2):
	...
	lumapi.evalScript( fdtd_hook.handle, 'scale_factor = max( abs( E ) );' )
	lumapi.evalScript( fdtd_hook.handle, 'E = E / scale_factor;' )
	lumapi.evalScript( fdtd_hook.handle, 'H = H / scale_factor;' )
