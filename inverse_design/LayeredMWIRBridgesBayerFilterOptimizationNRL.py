...
shutil.copy2(python_src_directory + "/LayeredMWIRBridgesBayerFilterOptimizationNRL.py", projects_directory_location + "/LayeredMWIRBridgesBayerFilterOptimizationNRL.py")
...
for epoch in range(start_epoch, num_epochs):
	...
	for iteration in range(start_iter, num_iterations_per_epoch):
		...
		for dispersive_range_idx in range( 0, num_dispersive_ranges ):
			if len( dispersive_range_to_adjoint_src_map[ dispersive_range_idx ] ) == 0:
				continue
