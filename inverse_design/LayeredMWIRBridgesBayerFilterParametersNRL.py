...
platform_thickness_um = 1.0

#
# Spectral
#
lambda_min_um = 2.5#3.5
lambda_max_um = 4.0#5.5
...
src_maximum_vertical_um = device_size_verical_um + vertical_gap_size_um * 0.5
...
polarizations_focal_plane_map = [ ['x'], ['x'], ['y'], ['y'] ]
