...
permittivity_block_left['y span'] = device_size_lateral_um * 1e-6
...
permittivity_block_right['x'] = 0
permittivity_block_right['x span'] = (2 * lateral_gap_size_um + device_size_lateral_um) * 1e-6
permittivity_block_right['y span'] = device_size_lateral_um * 1e-6
