...
permittivity_block_left['y span'] = (fdtd_region_size_lateral_um + lateral_gap_size_um) * 1e-6
...
permittivity_block_right['y span'] = (fdtd_region_size_lateral_um + lateral_gap_size_um) * 1e-6
