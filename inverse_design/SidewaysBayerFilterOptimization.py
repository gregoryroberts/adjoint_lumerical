...
from SidewaysBayerFilterParameters import *
import SidewaysBayerFilter
...
shutil.copy2(python_src_directory + "/SidewaysBayerFilterParameters.py", projects_directory_location + "/ArchiveSidewaysBayerFilterParameters.py")
...
permittivity_block_left['x span'] = 2 * lateral_gap_size_um * 1e-6
permittivity_block_left['y'] = 0 * 1e-6
permittivity_block_left['y span'] = (fdtd_region_size_lateral_um + 2 * lateral_gap_size_um) * 1e-6
permittivity_block_left['z max'] = device_vertical_maximum_um * 1e-6
permittivity_block_left['z min'] = device_vertical_minimum_um * 1e-6
...
permittivity_block_right['x span'] = 2 * lateral_gap_size_um * 1e-6
permittivity_block_right['y'] = 0 * 1e-6
permittivity_block_right['y span'] = (fdtd_region_size_lateral_um + 2 * lateral_gap_size_um) * 1e-6
permittivity_block_right['z max'] = device_vertical_maximum_um * 1e-6
permittivity_block_right['z min'] = device_vertical_minimum_um * 1e-6
permittivity_block_right['index'] = max_device_index
...
bayer_filter = SidewaysBayerFilter.SidewaysBayerFilter(bayer_filter_size_voxels, [min_device_permittivity, max_device_permittivity], init_permittivity_0_1_scale, num_vertical_layers)
