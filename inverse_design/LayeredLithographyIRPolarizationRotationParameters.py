...
# Files
#
project_name = 'layered_infrared_3layers_pol_splitter_parallel_fom_trisymmetric_v1_4p2x4p2x3p12um_f2p6'
...
effective_focal_length_sq_by_focal_point = [
	focal_length_um**2,
	focal_length_um**2 + ( device_size_lateral_um / 2. )**2
]

max_intensity_by_wavelength_by_focal_point = [
	(device_size_lateral_um**2)**2 / (effective_focal_length_sq_by_focal_point[ i ] * lambda_values_um**2)
	for i in range( 0, len( effective_focal_length_sq_by_focal_point ) ) ]
...
adjoint_x_positions_um = [ 0.0, device_size_lateral_um / 2. ]# -device_size_lateral_um / 4., -device_size_lateral_um / 4., device_size_lateral_um / 4.]
adjoint_y_positions_um = [ 0.0, 0.0 ]# [device_size_lateral_um / 4., device_size_lateral_um / 4., -device_size_lateral_um / 4., -device_size_lateral_um / 4.]
