...
from LayeredRedBridgesBayerFilterParameters import *
import LayeredRedBridgesBayerFilter
...
shutil.copy2(python_src_directory + "/LayeredRedBridgesBayerFilterParameters.py", projects_directory_location + "/ArchiveLayeredRedBridgesBayerFilterParameters.py")
...
bayer_filter = LayeredRedBridgesBayerFilter.LayeredRedBridgesBayerFilter(
