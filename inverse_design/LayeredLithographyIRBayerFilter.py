...
class LayeredLithographyIRBayerFilter(device.Device):
	...
	def update_permittivity(self):
		...
		var5[ :, :, self.layering_z_1.last_layer_end : var5.shape[ 2 ] ] = self.last_layer_permittivity[ 0 ]
	...
	def init_filters_and_variables(self):
		...
		self.layering_z_1 = layering.Layering(z_dimension_idx, self.num_z_layers, [0, 1], self.spacer_height_voxels, 0.0)
