...
# Spectral
#
# Consider putting a gap between wavelength bands or some kind of weighting function that tapers
lambda_min_um = 0.45
lambda_max_um = 0.65
# lambda_min_um = 0.8
# lambda_max_um = 1.4
...
ctrl_pts_change_start_epoch = 0.5
ctrl_pts_change_end_epoch = 0.1
