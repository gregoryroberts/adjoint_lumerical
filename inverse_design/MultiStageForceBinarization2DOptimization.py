...
from MultiStageForceBinarization2DParameters import *
		...
		for iteration in range( 0, num_iterations_per_epoch ):
			...
			for pol_idx in range( 0, num_polarizations ):
				...
				for focal_idx in range(0, num_focal_spots):
					...
					# 		figure_of_merit_total[ wl_idx + spectral_indices[ 0 ] ] += normalize * (
					...
					# 		conjugate_weighting_wavelength[ current_coord, wl_idx + spectral_indices[ 0 ] ] = normalize * np.conj(
