...
print( np.max( np.abs( forward_symmetry_fields - forward_compare_fields ) ) )
...
print( np.max( np.abs( adjoint_symmetry_fields_0 - adjoint_compare_fields_0 ) ) )
...
print( np.max( np.abs( adjoint_symmetry_fields_2 - adjoint_compare_fields_2 ) ) )
...
print( np.max( np.abs( adjoint_symmetry_fields_x_3 - adjoint_compare_fields_x_3 ) ) )
...
print( np.max( np.abs( adjoint_symmetry_fields_y_3 - adjoint_compare_fields_y_3 ) ) )
